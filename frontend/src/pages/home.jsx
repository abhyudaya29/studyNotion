                ...
                <div className="relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between">
                    ...
                    <div className="mx-3 my-12 shadow-blue-200">
                        <video className=""
                            ...
                            autoPlay
                            loop
                            src={Video} alt="there is a video" />
                    </div>
                    {/* code section 1 */}
                    ...
                    <div className="">
                        <CodeBlocks
                            ...
                            subheading={
                                "Our courses are described and taught by industry experts who have years of experience in the field of Technology"
                            }
                            ctab1={{
                            ...
                            codeblock={`const motivateYou = async () => {
                                try {
                                    ...
                                    console.error("Failed to retrieve motivational ,Try Once Again:", error);
                                }
                            };
                        }
                        `}
                    ...
                    <div className="">
                        <CodeBlocks
                            ...
                            subheading={
                                "Go ahead, give it a try. Our hands-on learning environment means you'll be writing real code from your lesson"
                            }
                            ctab1={{
